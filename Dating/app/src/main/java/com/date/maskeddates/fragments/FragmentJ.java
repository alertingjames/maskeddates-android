...
public class FragmentJ extends Fragment {
    ...
    ImageView firstbutton, secondbutton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Mac or PC?")) {
    ...
    public static FragmentJ newInstance(String text) {

        FragmentJ f = new FragmentJ();
        Bundle b = new Bundle();
