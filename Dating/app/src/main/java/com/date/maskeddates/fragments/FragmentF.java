...
public class FragmentF extends Fragment {
    ...
    ImageView firstbutton, secondbutton, thirdbutton, fourthbutton, fifthbutton, sixthbutton;
    TextView firsttext, secondtext, thirdtext, fourthtext, fifthtext, sixthtext;
    String checkedText = "";
    String answers = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fourth = (LinearLayout)v.findViewById(R.id.fourth);
        fifth = (LinearLayout)v.findViewById(R.id.fifth);
        sixth = (LinearLayout)v.findViewById(R.id.sixth);
        ...
        fifthbutton = (ImageView)v.findViewById(R.id.fifthbutton);
        sixthbutton = (ImageView)v.findViewById(R.id.sixthbutton);
        ...
        fourthtext = (TextView)v.findViewById(R.id.fourthtext);
        fifthtext = (TextView)v.findViewById(R.id.fifthtext);
        sixthtext = (TextView)v.findViewById(R.id.sixthtext);

        LinearLayout[] linearLayouts = {first, second, third, fourth, fifth, sixth};
        TextView[] textViews = {firsttext, secondtext, thirdtext, fourthtext, fifthtext, sixthtext};
        ImageView[] imageViews = {firstbutton, secondbutton, thirdbutton, fourthbutton, fifthbutton, sixthbutton};
        ...
        for(int mmm=0; mmm<textViews.length; mmm++)
            textViews[mmm].setTypeface(font);

        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Your Drink of Choice Is")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    clearAllCheckeds();
                    for(int j=0; j<textViews.length; j++){
                        if(answer.equals("I like " + textViews[j].getText().toString())){
                            imageViews[j].setImageResource(R.drawable.radioicon2);
                            linearLayouts[j].setBackgroundResource(R.drawable.red_fill_round2);
        ...
        for(int k=0; k<linearLayouts.length; k++){
            int finalK = k;
            linearLayouts[k].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    clearAllCheckeds();
                    imageViews[finalK].setImageResource(R.drawable.radioicon2);
                    linearLayouts[finalK].setBackgroundResource(R.drawable.red_fill_round2);
                    textViews[finalK].setTextColor(Color.WHITE);
                    checkedText = "I like " + textViews[finalK].getText().toString();
                    if (rope != null) {
                        rope.stop(true);
                    }
                    rope = YoYo.with(Techniques.Pulse)
    ...
    public static FragmentF newInstance(String text) {
    ...
    public void clearAllCheckeds(){
        ...
        fifthbutton.setImageResource(R.drawable.radioicon);
        sixthbutton.setImageResource(R.drawable.radioicon);
        ...
        thirdtext.setTextColor(Color.BLACK);
        fourthtext.setTextColor(Color.BLACK);
        fifthtext.setTextColor(Color.BLACK);
        sixthtext.setTextColor(Color.BLACK);
    }
