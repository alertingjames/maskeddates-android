...
public class FragmentK extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FrameLayout[] frameLayouts = {first, second, third};
        TextView[] textViews = {firsttext, secondtext, thirdtext};
        ImageView[] imageViews = {firstbutton, secondbutton, thirdbutton};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("A perfect date for you is")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    clearAllCheckeds();
                    if(answer.equals("I like Dinner and movie")){
                        imageViews[0].setImageResource(R.drawable.radioicon2);
                        frameLayouts[0].setBackgroundResource(R.drawable.red_fill_round2);
                        if (rope != null) {
                            rope.stop(true);
                        }
                        rope = YoYo.with(Techniques.Pulse)
                                .duration(400)
                                .repeat(2)
                                .playOn(frameLayouts[0]);
                    }else if(answer.equals("I like Adventure")){
                        imageViews[1].setImageResource(R.drawable.radioicon2);
                        frameLayouts[1].setBackgroundResource(R.drawable.red_fill_round2);
                        if (rope != null) {
                            rope.stop(true);
                        }
                        rope = YoYo.with(Techniques.Pulse)
                                .duration(400)
                                .repeat(2)
                                .playOn(frameLayouts[1]);
                    }else if(answer.equals("I like Long walk on the beach")){
                        imageViews[2].setImageResource(R.drawable.radioicon2);
                        frameLayouts[2].setBackgroundResource(R.drawable.red_fill_round2);
                        if (rope != null) {
                            rope.stop(true);
                        }
                        rope = YoYo.with(Techniques.Pulse)
        ...
        for(int k=0; k<frameLayouts.length; k++){
            ...
            frameLayouts[k].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(finalK == 0) checkedText = "I like Dinner and movie";
                    else if(finalK == 1) checkedText = "I like Adventure";
                    else if(finalK == 2) checkedText = "I like Long walk on the beach";
                    if (rope != null) {
                        rope.stop(true);
                    }
                    rope = YoYo.with(Techniques.Pulse)
    ...
    public static FragmentK newInstance(String text) {

        FragmentK f = new FragmentK();
        Bundle b = new Bundle();
