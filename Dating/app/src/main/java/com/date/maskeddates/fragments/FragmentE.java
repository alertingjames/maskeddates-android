...
public class FragmentE extends Fragment {
    ...
    RadioButton radioButton, first, second, third, fourth, fifth, sixth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RadioButton[] radioButtons = {first, second, third, fourth, fifth, sixth};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("What's the one thing you can't live without?")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I can't live without " + radioButtons[j].getText().toString().toLowerCase())){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("What's the one thing you can't live without?")) {
                                        Commons.questionnaires2.get(i).set_answer("I can't live without " + radioButton.getText().toString().toLowerCase());
    ...
    public static FragmentE newInstance(String text) {
