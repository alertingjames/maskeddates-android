...
public class FragmentN extends Fragment {
    FrameLayout first, second, third, fourth, fifth, sixth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fifth = (FrameLayout)v.findViewById(R.id.fifth);
        sixth = (FrameLayout)v.findViewById(R.id.sixth);
        ...
        FrameLayout[] frameLayouts = {first, second, third, fourth, fifth, sixth};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("What is your ideal weekend plan?")) {
    ...
    public static FragmentN newInstance(String text) {

        FragmentN f = new FragmentN();
        Bundle b = new Bundle();
