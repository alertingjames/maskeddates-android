...
public class FragmentM extends Fragment {
    ...
    RadioButton radioButton, first, second, third, fourth, fifth, sixth, seventh;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RadioButton[] radioButtons = {first, second, third, fourth, fifth, sixth, seventh};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("You find your inspiration by")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I like " + radioButtons[j].getText().toString())){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("You find your inspiration by")) {
                                        Commons.questionnaires2.get(i).set_answer("I like " + radioButton.getText().toString());
...
//        }
    ...
    public static FragmentM newInstance(String text) {

        FragmentM f = new FragmentM();
        Bundle b = new Bundle();
