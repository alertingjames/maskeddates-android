    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Are you a cat or a dog person?")) {
...
//        }
    ...
    public static FragmentT newInstance(String text) {

        FragmentT f = new FragmentT();
        Bundle b = new Bundle();
