...
public class FragmentG extends Fragment {
    FrameLayout first, second, third, fourth, fifth;
    ImageView firstbutton, secondbutton, thirdbutton, fourthbutton, fifthbutton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FrameLayout[] frameLayouts = {first, second, third, fourth, fifth};
        TextView[] textViews = {firsttext, secondtext, thirdtext, fourthtext, fifthtext};
        ImageView[] imageViews = {firstbutton, secondbutton, thirdbutton, fourthbutton, fifthbutton};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("What's Your Biggest Fear?")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    clearAllCheckeds();
                    for(int j=0; j<textViews.length; j++){
                        if(answer.equals("I Fear " + textViews[j].getText().toString().toLowerCase())){
                        ...
                        }else if(answer.equals("I Fear spiders")){
                            imageViews[3].setImageResource(R.drawable.radioicon2);
                            frameLayouts[3].setBackgroundResource(R.drawable.red_fill_round2);
                            if (rope != null) {
                                rope.stop(true);
                            }
                            rope = YoYo.with(Techniques.Pulse)
        ...
        for(int k=0; k<frameLayouts.length; k++){
            ...
            frameLayouts[k].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(finalK == 3)checkedText = "I Fear spiders";
                    else checkedText = "I Fear " + textViews[finalK].getText().toString().toLowerCase();
                    if (rope != null) {
                        rope.stop(true);
                    }
                    rope = YoYo.with(Techniques.Pulse)
    ...
    public static FragmentG newInstance(String text) {

        FragmentG f = new FragmentG();
        Bundle b = new Bundle();
