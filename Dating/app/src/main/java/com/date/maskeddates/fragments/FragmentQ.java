...
public class FragmentQ extends Fragment {
    ...
    RadioButton radioButton, first, second, third;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("How often do you read?")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I am Pretty much a bibliophile")){
                            radioButtons[0].setBackgroundResource(R.drawable.red_fill_round);
                            ...
                            rope = YoYo.with(Techniques.Pulse)
                                    .duration(400)
                                    .repeat(2)
                                    .playOn(radioButtons[0]);
                        }else if(answer.equals("I am Infrequent reader")){
                            radioButtons[1].setBackgroundResource(R.drawable.red_fill_round);
                            ...
                            rope = YoYo.with(Techniques.Pulse)
                                    .duration(400)
                                    .repeat(2)
                                    .playOn(radioButtons[1]);
                        }else if(answer.equals("I am Not much into reading")){
                            radioButtons[2].setBackgroundResource(R.drawable.red_fill_round);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("How often do you read?")) {
                                        if(radioButton.getText().equals("I am pretty much a bibliophile"))
                                            Commons.questionnaires2.get(i).set_answer("I am Pretty much a bibliophile");
                                        else if(radioButton.getText().equals("I pick up a good book here and there"))
                                            Commons.questionnaires2.get(i).set_answer("I am Infrequent reader");
                                        else if(radioButton.getText().equals("Don’t read much"))
                                            Commons.questionnaires2.get(i).set_answer("I am Not much into reading");
...
//        }
    ...
    public static FragmentQ newInstance(String text) {

        FragmentQ f = new FragmentQ();
        Bundle b = new Bundle();
