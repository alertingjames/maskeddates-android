...
public class FragmentC extends Fragment {
    ...
    RadioButton radioButton, first, second, third, fourth, fifth, sixth, seventh, eighth, ninth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ninth = (RadioButton) v.findViewById(R.id.ninth);

        RadioButton[] radioButtons = {first, second, third, fourth, fifth, sixth, seventh, eighth, ninth};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Favorite movie genre")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I like " + radioButtons[j].getText().toString() + " movies")){
                        ...
                        }else if(answer.equals("I like Sci-fi movies")){
                            radioButtons[5].setBackgroundResource(R.drawable.red_fill_round);
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("Favorite movie genre")) {
                                        if(radioButton.getText().equals("Science Fiction"))
                                            Commons.questionnaires2.get(i).set_answer("I like Sci-fi movies");
                                        else
                                            Commons.questionnaires2.get(i).set_answer("I like " + radioButton.getText().toString() + " movies");
...
//        }
        ...
        ninth.setBackgroundResource(R.drawable.red_stroke_round);
        ...
        ninth.setTextColor(getResources().getColor(R.color.colorAccent));
    }
