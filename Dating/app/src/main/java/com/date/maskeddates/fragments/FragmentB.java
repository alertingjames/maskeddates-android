...
public class FragmentB extends Fragment {
    ...
    RadioButton radioButton, first, second;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("When you have the choice of taking the stairs or the elevator, which one do you choose?")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I like Taking " + radioButtons[j].getText().toString().toLowerCase())){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("When you have the choice of taking the stairs or the elevator, which one do you choose?")) {
                                        Commons.questionnaires2.get(i).set_answer("I like Taking " + radioButton.getText().toString().toLowerCase());
