package com.date.maskeddates.Config;
...
public class Config extends Object{
    ...
    public static final String API_KEY = "AIzaSyBN7Zgi7_7isJ9Av3sdHOst-ffeeuU5gg8";

    public static final String appId = "7631DDD8-292F-461C-8F4E-ACD36BFFAD2D";
