    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Do You Like Change?")) {
                    String answer = Commons.questionnaires2.get(i).get_answer();
                    resetButtons();
                    for(int j=0; j < radioButtons.length; j++){
                        if(answer.equals("I Embrace change")){
                        ...
                        }else if(answer.equals("I Embrace change but also like routine")){
                        ...
                        }else if(answer.equals("I Like routine")){
                    ...
                    new Handler().postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(Commons.questionnaires2.size() > 0){
                                for(int i=0; i<Commons.questionnaires2.size(); i++){
                                    if(Commons.questionnaires2.get(i).get_text().equals("Do You Like Change?")) {
                                        if(radioButton.getText().equals("Yes, I embrace change"))
                                            Commons.questionnaires2.get(i).set_answer("I Embrace change");
                                        else if(radioButton.getText().equals("Sometimes, but I also like routine"))
                                            Commons.questionnaires2.get(i).set_answer("I Embrace change but also like routine");
                                        else if(radioButton.getText().equals("No, I prefer things to stay the same"))
                                            Commons.questionnaires2.get(i).set_answer("I Like routine");
...
//        }
    ...
    public static FragmentI newInstance(String text) {

        FragmentI f = new FragmentI();
        Bundle b = new Bundle();
