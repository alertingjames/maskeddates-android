...
public class FragmentA extends Fragment {
    ...
    RadioButton radioButton, first, second, third, fourth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RadioButton[] radioButtons = {first, second, third, fourth};
        ...
        if(Commons.questionnaires2.size() > 0){
            for(int i=0; i<Commons.questionnaires2.size(); i++){
                if(Commons.questionnaires2.get(i).get_text().equals("Describe Yourself")) {
